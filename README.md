...
###المشكلة سببها إن "البلوك" الخاص بالكود (Code Block) الذي يبدأ بـ ```bash عند جزئية Clone the Repository لم يتم إغلاقه، فالمتصفح (أو Github) اعتبر أن كل النصوص التي تليه هي جزء من الكود ووضعها داخل نفس الصندوق.

لقد قمت بإصلاح الأقواس، وفصلت كل أمر في صندوق خاص، وعدلت مسارات الصور لتتوافق مع ما اتفقنا عليه في الخطوة السابقة (بناءً على الملفات التي رفعتها).

تفضل الملف كاملاً وجاهز للنسخ:
